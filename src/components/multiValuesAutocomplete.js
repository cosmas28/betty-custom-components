(() => ({
  ...
  jsx: (() => {
    ...
    const defaultValue = useText(valueRaw, { rawValue: true }); // check
     ...
     *
     */
    const [value, setValue] = useState(initalValue); // check
    ...
    const valueProp = getProperty(valueProperty) || {}; // check
